	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="experiment" Type="Folder">
			<Item Name="Performance" Type="Folder">
				<Item Name=".Net Get Private Memory.vi" Type="VI" URL="../experiments/Perrformance/.Net Get Private Memory.vi"/>
				<Item Name="DSA_Sync_Metrics.vi" Type="VI" URL="../experiments/Perrformance/DSA_Sync_Metrics.vi"/>
				<Item Name="Lockin Noise Measurement.vi" Type="VI" URL="../experiments/Perrformance/Lockin Noise Measurement.vi"/>
				<Item Name="Lockin_Metrics.vi" Type="VI" URL="../experiments/Perrformance/Lockin_Metrics.vi"/>
				<Item Name="Lockin_Metrics_Results.vi" Type="VI" URL="../experiments/Perrformance/Lockin_Metrics_Results.vi"/>
				<Item Name="serialize_test.vi" Type="VI" URL="../experiments/Perrformance/serialize_test.vi"/>
			</Item>
			<Item Name="PLL" Type="Folder">
				<Item Name="PLL.lvproj" Type="Document" URL="../experiments/PLL/PLL.lvproj"/>
				<Item Name="PLL_PID.vi" Type="VI" URL="../experiments/PLL/PLL_PID.vi"/>
				<Item Name="PLL_PID_WithoutPIDToolkit.vi" Type="VI" URL="../experiments/PLL/PLL_PID_WithoutPIDToolkit.vi"/>
				<Item Name="PLL_Simple_WithoutTime.vi" Type="VI" URL="../experiments/PLL/PLL_Simple_WithoutTime.vi"/>
				<Item Name="PLL_Simple_WithTime.vi" Type="VI" URL="../experiments/PLL/PLL_Simple_WithTime.vi"/>
				<Item Name="Simple_PI.vi" Type="VI" URL="../experiments/PLL/Simple_PI.vi"/>
			</Item>
			<Item Name="Filter" Type="Folder">
				<Item Name="Filter Sandbox.vi" Type="VI" URL="../experiments/Filter/Filter Sandbox.vi"/>
				<Item Name="DFD Filter Response.vi" Type="VI" URL="../experiments/Filter/DFD Filter Response.vi"/>
			</Item>
			<Item Name="Phase Correction Result.vi" Type="VI" URL="../experiments/Phase Correction Result.vi"/>
			<Item Name="Test NES.vi" Type="VI" URL="../experiments/Test NES.vi"/>
			<Item Name="Test Event Registration.vi" Type="VI" URL="../experiments/Test Event Registration.vi"/>
			<Item Name="Test Queues.vi" Type="VI" URL="../experiments/Test Queues.vi"/>
			<Item Name="Test Decimation.vi" Type="VI" URL="../experiments/Test Decimation.vi"/>
			<Item Name="Decimate Result.vi" Type="VI" URL="../experiments/Decimate Result.vi"/>
			<Item Name="Test Dynamic Filter.vi" Type="VI" URL="../experiments/Test Dynamic Filter.vi"/>
			<Item Name="Test LIA Filtering.vi" Type="VI" URL="../experiments/Test LIA Filtering.vi"/>
			<Item Name="Filter Result.vi" Type="VI" URL="../experiments/Filter Result.vi"/>
			<Item Name="LP Filter Result.vi" Type="VI" URL="../experiments/LP Filter Result.vi"/>
		</Item>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Multichannel Lock-In (x64) Application" Type="EXE">
				...
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/Dependencies/Instrument.Lockin.lvlib/Instrument.Lockin.lvclass/Instrument.Lockin.AppLauncher.vi</Property>
				<Property Name="Source[1].sourceInclusion" Type="Str">TopLevel</Property>
				<Property Name="Source[1].type" Type="Str">VI</Property>
				<Property Name="Source[2].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[2].itemID" Type="Ref">/My Computer/Dependencies/Instrument.Lockin.lvlib</Property>
